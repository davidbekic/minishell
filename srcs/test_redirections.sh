...
printf "37. '[SETUP] cat > f1 f3 f4 > f1 f2'\n"
exec_test "echo 'a'  > f1"
exec_test "echo 'b'  > f2"
exec_test "echo 'c'  > f3"
exec_test "chmod 000 f2"
exec_test "cat > f1 f3 f4 > f1 f2"
exec_test "rm -f f1 f2 f3"

printf "38. '[SETUP] cat > f1 f3 f4 > f1 f2'\n"
exec_test "echo 'a'  > f1"
exec_test "echo 'b'  > f2"
exec_test "echo 'c'  > f3"
exec_test "chmod 000 f2"
exec_test "cat > f1 f3 f4 > f2"
exec_test "rm -f f1 f2 f3"

printf "39. '[SETUP] cat a < m1 m1 a m1 > r5\n"
exec_test "echo 'hola'  > a"
exec_test "echo 'chau'  > m1"
exec_test "cat a < m1 m1 a m1 > r5"
exec_test "cat r5"
exec_test "rm -f m1 a r5"

printf "40. '[SETUP] cat a > b>c <b\n"
exec_test "cat a > b>c <b"

printf "41. '[SETUP] cat a > b>c <d\n"
exec_test "touch d"
exec_test "chmod 000 d"
exec_test "cat a > b>c <d"
